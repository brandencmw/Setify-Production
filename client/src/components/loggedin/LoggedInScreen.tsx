...
function LoggedInScreen() {
  ...
  const [requestStatus, setRequestStatus] = React.useState<null | boolean>(
    null
  );
  ...
  React.useEffect(() => {
    if (token) {
      axios({
        method: "GET",
        url: "https://setify-merger.herokuapp.com/get-userdata",
  ...
  function mergePlaylists(formData: any) {
    axios({
      method: "GET",
      url: "https://setify-merger.herokuapp.com/merge-playlists",
